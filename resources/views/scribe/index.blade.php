    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="category-management">
                    <a href="#category-management">Category Management</a>
                                ...
                                <a href="#category-management-GETapi-v1-categories">List all categories</a>
                            </li>
                ...
                <li class="tocify-item level-1" data-unique="task-management">
                    <a href="#task-management">Task Management</a>
                                ...
                                <a href="#task-management-POSTapi-v1-tasks">Create a new task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-management-GETapi-v1-tasks--id-">
                                <a href="#task-management-GETapi-v1-tasks--id-">Get a specific task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-management-PUTapi-v1-tasks--id-">
                                <a href="#task-management-PUTapi-v1-tasks--id-">Update a task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-management-DELETEapi-v1-tasks--id-">
                                <a href="#task-management-DELETEapi-v1-tasks--id-">Delete a task</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="task-management-POSTapi-v1-tasks--task_id--image">
                                <a href="#task-management-POSTapi-v1-tasks--task_id--image">Upload task image</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This endpoint registers a new user and returns an access token.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The password of the user (min 8 characters). Example: <code>password123</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<p>This endpoint logs in a user and returns an access token.</p>
...
<p>This endpoint logs out the currently authenticated user by revoking their token.</p>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs for managing task categories</p>

                                <h2 id="category-management-GETapi-v1-categories">List all categories</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns all categories belonging to the authenticated user.</p>
...
<p>Creates a new category for the authenticated user.</p>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The name of the category. Example: <code>Work</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The color code for the category (hexadecimal). Example: <code>#ff0000</code></p>
        </div>
        </form>
...
<p>Returns details for a specific category if it belongs to the authenticated user.</p>
...
<p>Updates the specified category if it belongs to the authenticated user.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="category"                data-endpoint="PUTapi-v1-categories--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the category. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The name of the category. Example: <code>Work Tasks</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>color</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The color code for the category (hexadecimal). Example: <code>#0000ff</code></p>
        </div>
        </form>
...
<p>Deletes the specified category if it belongs to the authenticated user.
Associated tasks will have their category_id set to null.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="category"                data-endpoint="DELETEapi-v1-categories--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the category. Example: <code>1</code></p>
...
Results can be filtered by status, priority, category, and title search.</p>
...
<i>optional</i> &nbsp;
    ...
    <br>
<p>Filter tasks by status (pending, in_progress, completed). Example: <code>pending</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>Filter tasks by priority (low, medium, high). Example: <code>high</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category_id"                data-endpoint="GETapi-v1-tasks"
               value="1"
               data-component="query">
    <br>
<p>Filter tasks by category ID. Example: <code>1</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="query">
    <br>
<p>Search tasks by title. Example: <code>Project</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
...
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="page"                data-endpoint="GETapi-v1-tasks"
               value="1"
               data-component="query">
    <br>
<p>Page number for pagination. Example: <code>1</code></p>
                    ...
                    <h2 id="task-management-POSTapi-v1-tasks">Create a new task</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The title of the task. Example: <code>Complete project</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               value="Finish the API implementation"
               data-component="body">
    <br>
<p>The description of the task. Example: <code>Finish the API implementation</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The due date for the task. Example: <code>2023-12-31</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The status of the task (pending, in_progress, completed). Example: <code>pending</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>priority</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The priority of the task (low, medium, high). Example: <code>high</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category_id"                data-endpoint="POSTapi-v1-tasks"
               value="1"
               data-component="body">
    <br>
<p>The ID of the category for this task. Example: <code>1</code></p>
        </div>
        </form>

                    <h2 id="task-management-GETapi-v1-tasks--id-">Get a specific task</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Returns details for a specific task if it belongs to the authenticated user.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="task"                data-endpoint="GETapi-v1-tasks--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the task. Example: <code>1</code></p>
                    ...
                    <h2 id="task-management-PUTapi-v1-tasks--id-">Update a task</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Updates the specified task if it belongs to the authenticated user.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="task"                data-endpoint="PUTapi-v1-tasks--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the task. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The title of the task. Example: <code>Updated project title</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>description</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The description of the task. Example: <code>Updated description</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>due_date</code></b>&nbsp;&nbsp;
<small>date</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The due date for the task. Example: <code>2024-01-15</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>status</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The status of the task (pending, in_progress, completed). Example: <code>in_progress</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>priority</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>The priority of the task (low, medium, high). Example: <code>medium</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>category_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category_id"                data-endpoint="PUTapi-v1-tasks--id-"
               value="2"
               data-component="body">
    <br>
<p>The ID of the category for this task. Example: <code>2</code></p>
        </div>
        </form>

                    <h2 id="task-management-DELETEapi-v1-tasks--id-">Delete a task</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Deletes the specified task if it belongs to the authenticated user.</p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="task"                data-endpoint="DELETEapi-v1-tasks--id-"
               value="1"
               data-component="url">
    <br>
<p>The ID of the task. Example: <code>1</code></p>
                    ...
                    <h2 id="task-management-POSTapi-v1-tasks--task_id--image">Upload task image</h2>

<p>
<small class="badge badge-darkred">requires authentication</small>
</p>

<p>Uploads an image for the specified task if it belongs to the authenticated user.</p>

<span id="example-requests-POSTapi-v1-tasks--task_id--image">
<blockquote>Example request:</blockquote>
...
<span id="example-responses-POSTapi-v1-tasks--task_id--image">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-v1-tasks--task_id--image" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-v1-tasks--task_id--image"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-v1-tasks--task_id--image"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-v1-tasks--task_id--image" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-v1-tasks--task_id--image">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-v1-tasks--task_id--image" data-method="POST"
      data-path="api/v1/tasks/{task_id}/image"
      data-authed="1"
      data-hasfiles="1"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-v1-tasks--task_id--image', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-v1-tasks--task_id--image"
                    onclick="tryItOut('POSTapi-v1-tasks--task_id--image');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-v1-tasks--task_id--image"
                    onclick="cancelTryOut('POSTapi-v1-tasks--task_id--image');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-v1-tasks--task_id--image"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/v1/tasks/{task_id}/image</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-v1-tasks--task_id--image"
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-v1-tasks--task_id--image"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
                              name="task"                data-endpoint="POSTapi-v1-tasks--task_id--image"
               value="1"
               data-component="url">
    <br>
<p>The ID of the task. Example: <code>1</code></p>
...
<small>file</small>&nbsp;
 &nbsp;
                <input type="file" style="display: none"
                              name="image"                data-endpoint="POSTapi-v1-tasks--task_id--image"
               value=""
               data-component="body">
    <br>
